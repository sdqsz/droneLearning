...
#include "lesson_interfaces/msg/detail/num__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = lesson_interfaces::msg::Num;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const lesson_interfaces::msg::Num *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<lesson_interfaces::msg::Num *>(
    untyped_ros_message);
...
{
  return &lesson_interfaces::msg::typesupport_fastrtps_cpp::_Num__handle;
}
